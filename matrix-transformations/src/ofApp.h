...
class ofApp : public ofBaseApp{
	...
	public:
        ...
        std::vector<glm::vec2> square1{
            glm::vec2(-50, -50),
            glm::vec2(50, -50),
            glm::vec2(50, 50),
            glm::vec2(-50, 50)
        };
        std::vector<glm::vec2> square2{
            glm::vec2(-100, -100),
            glm::vec2(100, -100),
            glm::vec2(100, 100),
            glm::vec2(-100, 100)
    ...
    inline std::vector<glm::vec2> pointsToScreenCoords(const std::vector<glm::vec2>& points)
    {
        std::vector<glm::vec2> screenPoints; // create output vector
        ...
        for (int i = 0; i < points.size(); i++) {
            ...
            glm::vec4 origin(points[i].x, points[i].y, 0, 1);
            origin = modelMatrix * origin;
            screenPoints.emplace_back(glm::vec2(origin.x, origin.y));
        }
        return screenPoints;
    }
